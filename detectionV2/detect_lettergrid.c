// detect_lettergrid.c — version finale : pas carré + auto-offset vertical seulement
                            ...
                            guint8 R,guint8 G,guint8 B)
{
    ...
    /* --- correction uniquement sur l'axe Y --- */
    gy0 += cell_size/2;  // centre sur la première ligne
    // gx0 reste inchangé
